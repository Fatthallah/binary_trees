...
/**
 * create_node - The Definition I've to write to pass.
...
/**
 * pint_push - The Definition I've to write to pass.
 * @node: The Definition I've to write to pass.
 * @head: The Definition I've to write to pass.
 * @tail: The Definition I've to write to pass.
 * @func: The Definition I've to write to pass.
 *
...
/**
 * pop - The Definition I've to write to pass.
 * @head: The Definition I've to write to pass.
 */
void pop(levelorder_queue_t **head)
{
...
/**
 * free_queue - The Definition I've to write to pass.
 * @head: The Definition I've to write to pass.
 */
void free_queue(levelorder_queue_t *head)
{
